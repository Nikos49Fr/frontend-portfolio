        ...
        <article className='projects__project-card'>
            {imageSrc ? (
                <figure className='projects__project-media'>
                    <img className='projects__project-image' src={imageSrc} alt='' />
                </figure>
            ) : null}
            <div className='projects__project-body'>
                ...
                <div className='projects__project-footer'>
                    <ul className='projects__project-tags'>
                        {tags.map((tag, index) => (
                            <li key={index} className='projects__project-tag'>{tag}</li>
                        ))}
                    </ul>
                    {project.repoUrl ? (
                        <a className='projects__project-link' href={project.repoUrl} target='_blank' rel='noreferrer'>
                            <span className='code-label'>{codeSourceLabel}</span>
                            <span
